...
| 代码仓                | 代码仓介绍                                                                             | 代码仓地址                                      |
| ------------------ | --------------------------------------------------------------------------------- | ------------------------------------------ |
| cloud-native       | 鲲鹏云原生项目集合，包含多个针对鲲鹏处理器优化的云原生组件，基于Kubernetes提供云原生基础架构，网络和管理等鲲鹏亲和优化插件                | https://gitcode.com/boostkit/cloud-native  |
| cloud-virtual      | 鲲鹏虚拟化项目集合，包含多个针对鲲鹏处理器优化的虚拟化组件，覆盖KVM、QEMU、Libvirt、DPDK、SPDK等核心虚拟化与I/O软件栈的鲲鹏亲和优化特性。 | https://gitcode.com/boostkit/cloud-virtual |

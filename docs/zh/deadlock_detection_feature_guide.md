...
>-   若用户确实需要使用基于PMC/PMU的NMI Watchdog，则需要在系统启动参数中明确禁用SDEI Watchdog，具体操作为添加“disable\_sdei\_nmi\_watchdog“参数，完整参数请参见[使能](使能.md)一节。
...
### 使能<a name="ZH-CN_TOPIC_0000002105898413"></a>

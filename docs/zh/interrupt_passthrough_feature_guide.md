...
本章节介绍如何在鲲鹏920新型号处理器上使能中断直通特性。
 ...
 >开启GICv4.1使能中断直通特性且虚拟机配置的vcpupin和emulatorpin的绑核重叠时，出现性能下降的情况，请参见[配置GICv4.1后CPU利用率几乎达到100%，虚拟机性能下降](https://www.hikunpeng.com/document/detail/zh/kunpengcpfs/troubleshooting/trouble/kunpengcpfs_09_0021.html)进行处理。

...
| 文档版本 | 发布日期       | 修改说明                                                                                                                                 |
| ---- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| 01   | 2026-03-30 | 鲲鹏拓扑亲和插件KP-TAP新增支持NRI模式和Cluster亲和策略<br>首次发布Envoy使能KAE特性，提高网关加解密性能<br>首次发布鲲鹏虚拟机单核单页异常处理方案<br>首次发布GICv4.1超分性能优化方案，提高GICv4.1超分场景虚机内业务性能 |
### 版本配套说明
#### 产品版本信息
| 产品名称      | 产品版本     |
| --------- | -------- |
...
| 虚拟机单核单页异常处理   | 处理器<br><br>固件 | 鲲鹏920新型号处理器<br>鲲鹏950处理器<br>基础板CPLD大于7.0.0 |
